        ...
        <header className="fixed top-0 left-0 right-0 z-[9999] px-4 md:px-8 py-4 md:py-6 flex justify-between items-center bg-transparent">
            ...
            <div className="flex items-center gap-4">
                ...
                <nav className="hidden md:flex gap-8 text-white text-lg font-medium">
                    <Link href="/dashboard" className="hover:text-pink-300 transition">Home</Link>
            ...
            {open && (
                <div className="absolute top-full left-0 w-full bg-black/80 backdrop-blur-md py-4 px-6 flex flex-col gap-4 text-white text-lg md:hidden">
                    <Link href="/dashboard" onClick={() => setOpen(false)} className="hover:text-pink-300">Home</Link>
                    <Link href="/contact" onClick={() => setOpen(false)} className="hover:text-pink-300">Contact</Link>
                    <Link href="/about" onClick={() => setOpen(false)} className="hover:text-pink-300">About</Link>
                </div>
            )}
        </header>
    );
